import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name, name, arrayFrutas } from './App.vue';
...
for (const [fruta] of __VLS_getVForSourceType((__VLS_ctx.arrayFrutas)!)) {
{
